import{d as b,o as h,a as g,b as e,e as v,v as w,t as y,f as k,i,j as M,_}from"./index-CZ_E9aio.js";import{g as c}from"./marked.esm-DiRRsLPS.js";import{u as H}from"./useClipboard-CN7vQAas.js";const L={class:"flex gap-4 h-full"},T={class:"flex-1 flex flex-col min-w-0"},C={class:"flex-1 flex flex-col min-w-0"},O={class:"flex items-center justify-between mb-2"},U={class:"flex gap-2"},j=["innerHTML"],B=b({inheritAttrs:!1,__name:"index",setup(F,{expose:m}){m({meta:{id:"md-to-html",name:"Markdown → HTML",description:"将 Markdown 文本实时转换为 HTML，支持 GFM 语法",icon:"file-code",category:"document"}}),c.setOptions({gfm:!0,breaks:!1});const s=i(`# 欢迎使用 Markdown 转换器
